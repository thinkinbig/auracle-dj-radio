#!/usr/bin/env bash
# Idempotently create storage account + public read-only container; prints BLOB_BASE_URL / BLOB_HOST.
set -euo pipefail

SUBSCRIPTION="${SUBSCRIPTION:-cf1f480e-562c-4428-978e-5182874bcb0b}"
LOCATION="${LOCATION:-swedencentral}"
RG="${RG:-auracle-demo-rg}"
# Globally unique, 3-24 lowercase letters/digits. Override with STORAGE_ACCOUNT.
